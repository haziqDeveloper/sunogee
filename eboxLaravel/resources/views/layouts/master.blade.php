...
<meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('public/assets/img/letterlogo.png')}}" />
    ...
    <link rel="stylesheet" href="{{asset('public/assets/vendor/libs/apex-charts/apex-charts.css')}}" />
      <!--<link href="{{asset('public/plugins/DataTables/DataTables-1.10.18/css/jquery.dataTables.min.css')}}" rel="stylesheet" />-->
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="javascript:void(0);" class="menu-link">
                ...
                <div data-i18n="Misc">Shahid</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="{{url('domain-url')}}" class="menu-link">
                    <div data-i18n="Error">Domain Url</div>
                  </a>
                </li>
                <li class="menu-item active">
                  <a href="{{('contact-detail')}}" class="menu-link">
                    <div data-i18n="Under Maintenance">Contact Detail</div>
                  </a>
                </li>
                <li class="menu-item active">
                  <a href="{{('device_info')}}" class="menu-link">
                    <div data-i18n="Under Maintenance">Device Info</div>
                  </a>
                </li>
                <li class="menu-item active">
                  <a href="{{('update-version')}}" class="menu-link">
...
<div class="admin-dashboard">
  @yield('content')
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0 footer-bottom">
                  © 2023 Copyright Created By <strong>Shahid</strong>.
                </div>
              </div>
            </footer>
            <!-- / Footer -->
    ...
    <!--<script src="{{asset('public/plugins/DataTables/DataTables-1.10.18/js/jquery.dataTables.min.js')}}"></script>-->
