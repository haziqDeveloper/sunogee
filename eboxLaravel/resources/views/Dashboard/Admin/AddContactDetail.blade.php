...
<div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">King 4K Contact Detail</h5>
                    </div>
                    <div class="card-body">
                      ...
                      @foreach ($contact as $cont)
                        <div class="mb-3">
                          ...
                          <input type="email" class="form-control" name="email" value="{{ $cont->email }}" id="basic-default-fullname" placeholder="info@kin4k.com"/>
                        </div>
                        <div class="mb-3">
